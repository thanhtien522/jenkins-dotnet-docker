...
ENV DOTNET_CORE_SDK_VERSION 1.0.1
RUN curl -SL https://dotnetcli.blob.core.windows.net/dotnet/preview/Binaries/1.0/dotnet-dev-debian-x64.1.0.tar.gz --output dotnet.tar.gz \
